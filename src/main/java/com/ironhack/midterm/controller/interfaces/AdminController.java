...
public interface AdminController {
    ...
    public Transaction debitAccount(SecuredUser securedUser, Long accountId, AmountDTO amountDTO);
    public Transaction creditAccount(SecuredUser securedUser, Long accountId, AmountDTO amountDTO);
}
